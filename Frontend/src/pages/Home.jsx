    ...
    return (
      <div className='home-page'>
        ...
        <h3 className="marquee" style={{ color: 'crimson' }}>
          Helpline Numbers under the Tele Programme : ☎️ 14416 or 📞 1-800 891 4416
        </h3>
      </div>
        <div className='home-allcontent'>

        <div className='home-project-intro-image'>
          <img src='https://tse1.mm.bing.net/th/id/OIP.Zyblg9WldMhlcuxeeenGUQHaE7?r=0&rs=1&pid=ImgDetMain&o=7&rm=3' alt='Sukoon: Embrace, Empower, Elevate' ></img>
